  ...
  @if ($errors->any())
    ...
    <form method="post" enctype="multipart/form-data" action="{{route('admin.apartments.store')}}">
        ...
        <div class="mb-3">
          ...
          <input name="title" type="text" class="form-control" id="title" aria-describedby="title" value="{{old('title')}}">
        </div>
    
        <div class="mb-3">
          <label for="rooms" class="form-label">Stanze</label>
          <input name="rooms" type="number" class="form-control" id="rooms" value="{{old('rooms')}}">
        </div>
    
        <div class="mb-3">
            <label for="beds" class="form-label">Letti</label>
            <input name="beds" type="number" class="form-control" id="beds" value="{{old('beds')}}">
          </div>
    
          <div class="mb-3">
            <label for="bathrooms" class="form-label">Bagni</label>
            <input name="bathrooms" type="number" class="form-control" id="bathrooms" value="{{old('bathrooms')}}">
          </div>
    
            <div class="mb-3">
                <label for="square_meters" class="form-label">Metri quadri</label>
                <input name="square_meters" type="number" class="form-control" id="square_meters" value="{{old('square_meters')}}">
            </div>
